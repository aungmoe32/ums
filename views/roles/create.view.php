    ...
    <form action="/roles" method="POST">
        ...
        <div class="form-group">
            <div class="flex w-full max-w-xs flex-col gap-1 text-neutral-800 dark:text-neutral-300">
                ...
                <input id="textInputDefault" required type="text" name="role" value="<?= old('role') ?>" class="w-full rounded-xl border border-neutral-300 bg-neutral-200 px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-purple-500 disabled:cursor-not-allowed disabled:opacity-75 dark:border-neutral-700 dark:bg-neutral-900/50 dark:focus-visible:outline-purple-400" name="role" placeholder="Enter your role" autocomplete="role" />
            </div>
